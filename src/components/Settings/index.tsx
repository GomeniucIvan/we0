...
export const TAB_KEYS = {
  ...
  MODEL_PROVIDERS: "ModelProviders" as const,
    ...
    icon: (
      ...
      >
        <path
          ...
          strokeLinejoin="round"
          strokeWidth={2}
          d="M9 12h6m-6 4h6M5 8h14M5 8a2 2 0 012-2h10a2 2 0 012 2M5 8v10a2 2 0 002 2h10a2 2 0 002-2V8"
        />
      </svg>
    ),
  });
    ...
    >
      ...
      >
        ...
        <div className="flex-1 p-5 overflow-y-auto">
          ...
          {activeTab === TAB_KEYS.MODEL_PROVIDERS && <ModelProviderSettings />}
