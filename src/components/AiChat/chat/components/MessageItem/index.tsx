...
export const MessageItem: React.FC<MessageItemProps> = ({
  ...
  const filterMessages = useMemo(() => filterContent(message), [message]);
  const fullText = useMemo(
    () => processStreamParts(filterMessages.parts),
    [filterMessages]
  );
  ...
  return (
    <div className="group relative animate-in fade-in-0 slide-in-from-bottom-2">
      <div className="flex flex-col gap-2 px-2 py-1.5 rounded-lg hover:bg-gray-50 dark:hover:bg-white/[0.02] transition-colors">
        <div className="flex items-start gap-2">
          ...
          <div className="flex-1 min-w-0">
            {message.summary && (
              <div className="leading-relaxed prose-sm prose text-gray-900 dark:text-gray-100 dark:prose-invert max-w-none mb-2">
              ...
              <div className="flex flex-col gap-1">
                {showFullMessage ? (
                  ...
                  <div className="leading-relaxed prose-sm prose text-gray-900 dark:text-gray-100 dark:prose-invert max-w-none">
                    ...
                    {fullText.length > summaryText.length && (
                      <button
